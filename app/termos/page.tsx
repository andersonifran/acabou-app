      ...
      <main className="max-w-3xl mx-auto px-6 py-8 prose prose-gray">
        ...
        <section className="mb-8">
          ...
          <ul className="text-gray-600 space-y-2 list-disc pl-5">
            ...
            <li><strong>Plano Família Mensal (R$ 9,90/mês):</strong> Renovado automaticamente todo mês.</li>
            <li><strong>Plano Família Anual (R$ 79,90/ano):</strong> Renovado automaticamente todo ano.</li>
