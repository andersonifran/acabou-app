...
export const SUGGESTED_ITEMS: { name: string; category: string }[] = [
  ...
  { name: "Óleo", category: "Mercado" },
  { name: "Café", category: "Mercado" },
  { name: "Açúcar", category: "Mercado" },
  { name: "Sal", category: "Mercado" },
  { name: "Leite", category: "Mercado" },
  { name: "Ovos", category: "Mercado" },
  { name: "Pão", category: "Mercado" },
  { name: "Manteiga", category: "Mercado" },
  { name: "Macarrão", category: "Mercado" },
  { name: "Molho de tomate", category: "Mercado" },
  { name: "Farinha", category: "Mercado" },
  { name: "Carne", category: "Mercado" },
  { name: "Frango", category: "Mercado" },
  { name: "Queijo", category: "Mercado" },
  { name: "Presunto", category: "Mercado" },
  { name: "Frutas", category: "Mercado" },
  { name: "Verduras", category: "Mercado" },
  { name: "Legumes", category: "Mercado" },
  // Limpeza
